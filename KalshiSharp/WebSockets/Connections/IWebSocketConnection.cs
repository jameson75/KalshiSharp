...
public interface IWebSocketConnection : IAsyncDisposable
{
    ...
    /// <param name="headers">Optional headers to include in the handshake.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
    Task ConnectAsync(Uri uri, IReadOnlyDictionary<string, string>? headers = null, CancellationToken cancellationToken = default);
