...
[JsonSerializable(typeof(StandardHoursEntry))]
[JsonSerializable(typeof(TradingHours))]
...
// List response types (with correct API property names)
[JsonSerializable(typeof(MarketsResponse))]
...
[JsonSerializable(typeof(FillsResponse))]
...
[JsonSerializable(typeof(IReadOnlyList<StandardHoursEntry>))]
[JsonSerializable(typeof(IReadOnlyList<TradingHours>))]
[JsonSerializable(typeof(IReadOnlyList<MaintenanceWindow>))]
