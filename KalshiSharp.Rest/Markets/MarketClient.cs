...
internal sealed class MarketClient : IMarketClient
{
    ...
    /// <inheritdoc />
    public Task<PagedResponse<MarketResponse>> ListMarketsAsync(MarketQuery? query = null, CancellationToken cancellationToken = default)
    {
        ...
        return _httpClient.SendAsync<PagedResponse<MarketResponse>>(request, cancellationToken);
    }
    ...
    /// <inheritdoc />
    public Task<PagedResponse<TradeResponse>> GetTradesAsync(string ticker, string? cursor = null, int? limit = null, CancellationToken cancellationToken = default)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(ticker);
        ...
        return _httpClient.SendAsync<PagedResponse<TradeResponse>>(request, cancellationToken);
    }
}
