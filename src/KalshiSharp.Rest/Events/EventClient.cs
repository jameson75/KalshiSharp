...
internal sealed class EventClient : IEventClient
{
    ...
    /// <inheritdoc />
    public Task<PagedResponse<EventResponse>> ListEventsAsync(EventQuery? query = null, CancellationToken cancellationToken = default)
    {
        ...
        return _httpClient.SendAsync<PagedResponse<EventResponse>>(request, cancellationToken);
    }
}
